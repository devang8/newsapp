...
import 'package:newsapp/Screens/ViewNewsScreen.dart';
    ...
    return showDialog<void>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text(
              "Hi, This is Devang Mehta from L.D. College of engineering, Ahmedabad."),
          actions: <Widget>[
            TextButton(
              child: const Text('Ok'),
              onPressed: () {
            ...
            children: [
              DrawerHeader(
                  ...
                  child: Column(
                    ...
                    children: [
                      Image.asset("assets/images/news_image.jpg",
                          height: 70, width: 70),
                      const SizedBox(
                        height: 5,
                      ),
